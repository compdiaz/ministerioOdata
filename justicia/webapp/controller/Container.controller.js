sap.ui.define([
    ...
    return BaseController.extend("justicia.controller.Container",{

        onInit: function () {
            let oJSONModeljusticia = new JSONModel(),
            ...
            oJSONModeljusticia.loadData("../localService/mockdata/Employees.json");
            oView.setModel(oJSONModeljusticia, "jsonjusticia");
            ...
            this._oEventBus.subscribe("Incidence", "onDeleteIncidence", function (sChannel, sNameEvent, oData) {
                ...
                let sUrl = "/IncidentsSet(IncidenceId='"+oData.IncidenceId+"',SapId='"+oData.SapId+"',Pernr='"+oData.EmployeeID+"')";
        ...
        onShowEmployeeDetails: function (sChannel, sNameEvent, sPath) {
            let oDetails = this.getView().byId("details");
                oDetails.bindElement("mainService>"+sPath);
        ...
        onSaveODataIncidence: function (sChannel, sEventName, oObj) {
            ...
            let oResourceBundle = this.getView().getModel("i18n").getResourceBundle(),
                sEmployeeId = this._oDetail.getBindingContext("mainService").getProperty("Pernr"),
            ...
            this.getOwnerComponent().getModel("incidenceModel").read(sUrl, {
                ...
                success: function (data) {
                    ...
                    for (let oIncidence in data.results) {
                        let oNewIncidence = sap.ui.xmlfragment("justicia.fragment.NewIncidence", oController._oDetail.getController());
