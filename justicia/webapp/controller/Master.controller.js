sap.ui.define([
    ...
    function (BaseController, Filter, FilterOperator) {
        ...
        return BaseController.extend("justicia.controller.Master", {
            ...
            onClearFilter: function () {
                ...
                let oModel = this.getView().getModel("jsonCountries"),
                    oEmployeeModel = this.getView().getModel("mainService");
                ...
                this.getView().byId("tableEmployee").setHeaderText("justicia: (" + oEmployeeModel.getProperty("/Amount") + ")");
            ...
            onShowOrders: function (oEvent) {
                ...
                oCellOrderID.bindProperty("title", "mainService>Pernr");
                oTemplate2.addCell(oCellOrderID);

                let oCellFreight = new sap.m.Text();
                oCellFreight.bindProperty("text", "mainService>Pernr");
                oTemplate2.addCell(oCellFreight);

                let oCellShipAddress = new sap.m.Text();
                oCellShipAddress.bindProperty("text", "mainService>Pernr");
                ...
                oNewTable.bindElement("mainService>" + oBindingContext.getPath());
            ...
            onOpenDialog: function (oEvent) {
                ...
                if (!this.pDialogOrders) {
                    this.pDialogOrders = sap.ui.xmlfragment("justicia.fragment.DialogOrders", this);
                    this.getView().addDependent(this.pDialogOrders);
                }

                this.pDialogOrders.bindElement("mainService>" + oBindingContext.getPath());
                console.log(oItem);
            ...
            onNavToDetails: function (oEvent) {
                let oBinding = oEvent.getSource().getBindingContext("mainService"),
